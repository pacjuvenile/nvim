...
vim.keymap.set("n", "<C-h>",[[<C-w>h]], { noremap = true }) -- 移至左窗口
vim.keymap.set("n", "<C-l>",[[<C-w>l]], { noremap = true }) -- 移至右窗口
vim.keymap.set("n", "<C-j>",[[<C-w>j]], { noremap = true }) -- 移至下窗口
vim.keymap.set("n", "<C-k>",[[<C-w>k]], { noremap = true }) -- 移至上窗口
