...
vim.keymap.set("n", "H", [[<CMD>bprevious<CR>]])                         -- 切换至上一个buffer
vim.keymap.set("n", "L", [[<CMD>bnext<CR>]])                             -- 切换至下一个buffer
...
vim.keymap.set("n", "<C-A-r>", [[<Cmd>silent !/mnt/c/Users/sunny/app/rime/weasel-0.17.4/WeaselDeployer.exe /deploy<CR>]], { silent = true }) -- 重新部署rime
